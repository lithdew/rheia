...
pub const Packet = struct {
    pub const header_size = binary.sizeOfAll(Packet.Data);
    ...
    pub usingnamespace binary.Decoder(Packet, Packet.Data);
    ...
    pub fn append(dst: binary.Buffer, data: Packet.Data) !binary.Buffer {
        return binary.writeAll(dst, data);
    }
};
